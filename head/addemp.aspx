<%@ Page Title="" Language="C#" MasterPageFile="~/head/Head.Master" AutoEventWireup="true" CodeBehind="addemp.aspx.cs" Inherits="_2019MU.head.addemp" %>
              ...
              <div class="card-body pd-x-20 pd-xs-40">
                <h5 class="tx-xs-24 tx-normal tx-gray-900 mg-b-15">Add Employee Login</h5>
                 ...
                 <div class="form-group">
                    <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control" placeholder="Enter Login Name" OnTextChanged="txtUsername_TextChanged" AutoPostBack="true"></asp:TextBox>
